...
block 'create roles' do
  ...
  log wmr   = Role.create!(name: 'WorshipfulMaster',  display_name: 'MvSt',                                      administrational_role: false)
  log sr    = Role.create!(name: 'InternalSecretary', display_name: 'Protokolliernder Schriftführer',            administrational_role: false)
  log sr    = Role.create!(name: 'Secretary',         display_name: 'Korrespondierender Schriftführer',          administrational_role: false)
  log ser   = Role.create!(name: 'SeniorWarden',      display_name: '1. Aufseher',                               administrational_role: false)
  log jwr   = Role.create!(name: 'JuniorWarden',      display_name: '2. Aufseher',                               administrational_role: false)
  log mocr  = Role.create!(name: 'MemberOfCouncil',   display_name: 'Mitglieder des Beamtenrates',  group: true)
  log         Role.create!(name: 'HonoryMember',      display_name: 'Ehrenmitglied',  group: true,               administrational_role: false)
  log         Role.create!(name: 'Deakan',            display_name: 'Wachhabender',                              administrational_role: false)
  log         Role.create!(name: 'Speaker',           display_name: 'Redner',                                    administrational_role: false)
  log         Role.create!(name: 'Musician',          display_name: 'Musikmeister',                              administrational_role: false)
  log         Role.create!(name: 'MasterOfCeremony',  display_name: 'Zeremonienmeister',                         administrational_role: false)
  log         Role.create!(name: 'PreparingBrother',  display_name: 'Vorbereitender Bruder',                     administrational_role: false)
  log         Role.create!(name: 'PastMaster',        display_name: 'Altstuhlmeister',              group: true, administrational_role: false)
  log         Role.create!(name: 'DedicatedMaster',   display_name: 'zug. Meister',                 group: true, administrational_role: false)
  log         Role.create!(name: 'Treasurer',         display_name: 'Schatzmeister',                             administrational_role: false)
  log         Role.create!(name: 'JuniorDeacon',      display_name: '2. Schaffer',                               administrational_role: false)
  log         Role.create!(name: 'SeniorDeacon',      display_name: '1. Schaffer',                               administrational_role: false)
  log         Role.create!(name: 'NetDelegate',       display_name: 'Internet-Beauftragter',  group: true,       administrational_role: false)
