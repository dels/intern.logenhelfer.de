...
const server = setupServer(
  http.get('/api/v1/public/help', () => HttpResponse.json({ html: '<h2 id="test-heading">Testhilfe</h2>' })),
);
...
describe('HelpPage', () => {
  ...
  it('shows a loading indicator while the content is loading', async () => {
    server.use(
      http.get('/api/v1/public/help', async () => {
