...
import { useImpressum } from '../features/public-landing/impressum-api';

export default function ImpressumPage() {
  const { data, isLoading } = useImpressum();
  ...
  // The API returns admin-authored HTML (AppConfig[:impressum], editable
